                ...
                <div className="flex items-center mt-2.5 mb-5">
                    <div style={{ display: 'flex' }}>
                        {[1, 2, 3, 4, 5].map((star) => (
                            <svg
                                key={star}
                                className={`w-4 h-4 ${starColor(star)}`}
                                aria-hidden="true"
                    ...
                    <span className={`bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded ${darkMode ? 'dark:bg-blue-200 dark:text-blue-800' : 'bg-blue-100 text-blue-800'} ml-3`}>
                        {rating}
                    </span>
                </div>
